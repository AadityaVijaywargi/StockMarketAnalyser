    ...
    return (
      ...
      >
        ...
        {n.timeline && n.timeline.length > 0 && (
          <div className="text-[10px] font-mono text-brandText mb-2 font-bold">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-borderDark/60 text-[11px] font-mono">
          ...
          <button
            ...
            className="flex items-center gap-1 text-brandText hover:text-brand/80 font-bold transition-transform group-hover:translate-x-0.5 cursor-pointer"
          >
      ...
      <aside className="w-[64px] bg-background border-l border-borderDark h-screen flex flex-col justify-between items-center py-4 z-40 shrink-0 transition-all duration-300">
        <div className="flex flex-col items-center gap-4">
          <button
            ...
            className="p-2 rounded-lg bg-brand/10 text-brandText hover:bg-brand/20 border border-brand/20 transition-all cursor-pointer"
    ...
    <aside className="w-[420px] min-w-[380px] max-w-[450px] bg-background border-l border-borderDark h-screen flex flex-col justify-between shadow-premium z-40 shrink-0 transition-all duration-300 overflow-hidden">
      ...
      <div className="p-4 border-b border-borderDark bg-surface flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2.5">
          <div className="p-2 rounded-xl bg-brand/10 border border-brand/20 text-brandText">
        ...
        {notifications.length > 0 && (
          <div className="flex items-center justify-between pt-1 text-[11px] font-mono">
            <button
              ...
              className="flex items-center gap-1 text-brandText hover:text-brand/80 font-semibold transition-colors cursor-pointer"
            >
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-5">
        {filteredNotifications.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-center gap-3 my-auto py-12">
            <div className="w-12 h-12 rounded-2xl bg-brand/10 border border-brand/20 flex items-center justify-center text-brandText">
          ...
          <>
            ...
            {renderSection('Unread Notifications', grouped.unread, <Bell className="w-3 h-3 text-brandText" />)}
